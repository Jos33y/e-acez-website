<?php
$active = "shop";
$title = "shops template";
include('header.php')

?>
  <!-- active shops header-->

  <div class="container-fluid template-shops-header">
          <div class="text-center">
            <h1 class="heading">Shop Templates</h1>
                <p class="sub-heading">Below are available shop templates</p>
                <div class="button">
    ...
    <div class="row shop-box">
        ...
        <!-- shop 2-->
        <div class="col-md-4 col-sm-4 ">
          <span class="steps">Template eleven:</span>
          <div class="card">
            <div class="card-header"> Modist</div>
            <img class="card-img-top" src="images/modist.jpg" alt="Shop Image">
            <div class="card-footer">
      ...
      <!-- shop 3 -->
        <div class="col-md-4 col-sm-4">
          <span class="steps">Template twelve:</span>
          <div class="card">
            <div class="card-header"> The Plaza</div>
            <img class="card-img-top" src="images/theplaza.jpg" alt="Shop Image">
            <div class="card-footer">
