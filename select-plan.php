...
<div class="container">
  <h1>E-acez Confirm Payment Page with all neccessary links</h1>
<ul>
  <li class="nav-item"><a class="nav-link" href="index.php" >Home page </a></li>
   ...
   <li class="nav-item active"><a class="nav-link" href="confirm-payment.php">confirm payment</a></li>
   <li class="nav-item"><a class="nav-link" href="template.php">Back</a></li>
</ul>
</div>
</body>
</html>
