...
<div class="container">
  <h1>E-acez Template Page with all neccessary links</h1>
<ul>
  <li class="nav-item"><a class="nav-link" href="index.php" >Home page </a></li>
   ...
   <li class="nav-item active"><a class="nav-link" href="select-plan.php">Select Plan</a></li>
   <li class="nav-item"><a class="nav-link" href="sign-up.php">Back</a></li>
</ul>
</div>
</body>
</html>
